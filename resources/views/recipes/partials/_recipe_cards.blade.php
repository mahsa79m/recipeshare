@forelse ($recipes as $recipe)
    <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-1 transition-all duration-300 group">
        <a href="{{ route('recipes.show', $recipe) }}">
            <!-- بخش تصویر -->
            {{--
                این div یک کادر ثابت و مربع با استفاده از کلاس های Tailwind CSS ایجاد می کند.
                کلاس "aspect-w-1 aspect-h-1" نسبت ابعاد 1:1 را تنظیم می کند.
            --}}
            <div class="relative aspect-square">
                {{--
                    کلاس "object-cover" تصویر را مجبور می کند تا کل کادر مربع را پر کند.
                    اگر ابعاد تصویر با کادر مربع همخوانی نداشته باشد، تصویر برش داده می شود
                    تا شکل آن کشیده نشود.
                --}}
